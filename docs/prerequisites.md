...
*Note:* Your Google Cloud project needs to be whitelisted to be able to use Visual Inspection AI Edge. Please reach out to your Google Cloud sales representative to whitelist your project.
